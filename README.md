  ...
  <h1 align="center">Hey 👋 I'm Uttam Zure</h1>
...
<div style="display: flex; align-items: flex-start;">
  ...
  <div>
    <img 
      ...
      style="width: 180px; border-radius: 10px; margin-left: 20px;" 
    />
  </div>
</div>
...
|------|----------------|----------|
| **Cloud** | AWS | - [Configure a Static Website with S3]()<br>- [Securing VPC]()<br>- Scale the application using AWS resources |
...
<!--
**techrohitx/techrohitx** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
